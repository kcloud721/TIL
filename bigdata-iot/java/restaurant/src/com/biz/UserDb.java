...
public class UserDb extends Db<String, Table> {
...
//			pstmt.setString(3, v.getId());
	...
	@Override
	public Table select(String k) throws Exception {
		Table user = null;
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rset = null;
...
//			user = new DinningTable(id, pwd, name);		
		} catch(Exception e) {
			throw e;
		} finally {
			close(rset);
	...
	@Override
	public ArrayList<Table> select() throws Exception {
...
//				String pwd = rset.getString("PWD");
//				String name = rset.getString("NAME");
//				DinningTable user = new DinningTable(id, pwd, name);
//				list.add(user);
//			}
//		} catch(Exception e) {
//			throw e;
