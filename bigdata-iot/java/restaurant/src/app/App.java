...
public class App {
	...
	Db<String, Table> tableDb;
	ArrayList<Table> ulist = null; //----------------------
	public App() {}
	public App(Db<String, Table> tableDb) {
...
//				DinningTable user = ulist.get(index);
