...
/**
 * Servlet implementation class GetDataServelet32
 */
@WebServlet({ "/GetDataServelet32", "/getdata32" })
public class GetDataServelet32 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetDataServelet32() {
        super();
